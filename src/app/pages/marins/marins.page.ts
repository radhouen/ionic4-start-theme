...
@Component({
  selector: 'app-marins',
  templateUrl: './marins.page.html',
  styleUrls: ['./marins.page.scss'],
})
export class MarinsPage implements OnInit {
  ...
  nextStep() {
    this.pqservice.marinsQuantities = this.command;
    console.log(this.pqservice.marinsQuantities);
    this.navCtrl.navigateRoot('/httemps');
  }
